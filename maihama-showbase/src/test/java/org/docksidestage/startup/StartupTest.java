 ...
 * @author jflute
 */
public class StartupTest extends UnitShowbaseTestCase {
    ...
    public void test_startup_actually() throws Exception {
        ...
        final String serviceName = "showshining";
        final String appName = "oneman";
        startupLogic.fromShowbase(repositoryDir, domain, serviceName, appName);
