...
import org.docksidestage.mylasta.direction.sponsor.OrleansApiFailureHook.UnifiedFailureResult.FailureErrorPart;
 ...
 * @author jflute
 */
public class OrleansApiFailureHook extends MaihamaApiFailureHook { // #change_it for handling API failure
