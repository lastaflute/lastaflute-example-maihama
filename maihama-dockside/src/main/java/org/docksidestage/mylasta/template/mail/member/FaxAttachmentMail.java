 ...
 */
package org.docksidestage.mylasta.template.mail.member;
 ...
 * @author FreeGen
 */
public class FaxAttachmentMail implements TemplatePmb {

    public static final String PATH = "mail/member/fax_attachment.dfpm";

    public static String parsedBy(TemplateManager templateManager, TPCall<FaxAttachmentMail> oneArgLambda) {
        FaxAttachmentMail pmb = new FaxAttachmentMail();
