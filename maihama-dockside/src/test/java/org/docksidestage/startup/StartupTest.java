 ...
 * @author jflute
 */
public class StartupTest extends UnitDocksideTestCase {
    ...
    public void test_startup_actually() throws Exception {
        ...
        final String serviceName = "showdance";
        final String appName = "overthewaves";
        startupLogic.fromDockside(repositoryDir, domain, serviceName, appName);
