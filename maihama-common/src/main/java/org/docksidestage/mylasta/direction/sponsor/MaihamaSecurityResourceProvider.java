 ...
 * @author jflute
 */
public class MaihamaSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public MaihamaSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
