...
public class MaihamaApiFailureHook implements ApiFailureHook { // #change_it for handling API failure
    ...
    protected TooSimpleFailureBean createFailureBean(TooSimpleBizStatus bizStatus, ApiFailureResource resource) {
        return new TooSimpleFailureBean(bizStatus, resource.getPropertyMessageMap());
    }
    ...
    public static class TooSimpleFailureBean {
        ...
        public TooSimpleFailureBean(TooSimpleBizStatus bizStatus, Map<String, List<String>> messages) {
